...
def get_location_by_ref(yaw_degree, dji, latitude_degree, longitude_degree):
	match dji['GPSLatitudeRef']:
		case 'N':
		case 'S':
	...
	if exif_data is not None:
		for tag, value in exif_data.items():
			...
			if tag_name == 'GPSInfo':
				...
				xmp_dict["GPSLatitude"] = latitude_dd
				xmp_dict["GPSLongitude"] longitude_dd
				
				xmp_dict["GPSLatitudeRef"] = gps_info.get('GPSLatitudeRef', 'N')
				xmp_dict["GPSLongitudeRef"] gps_info.get('GPSLongitudeRef', 'E')
